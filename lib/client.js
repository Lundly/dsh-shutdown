...
/* shell.overlay 浮层条目：宿主 overlay 层自带 inset:0 + pointer-events:none，
   条目自身定位到右上角，面积仅覆盖按钮区域避免拦截无关点击。 */
...
.dsh-shutdown-card {
  ...
  box-shadow: var(--dsw-elevation-prominent, 0 12px 40px rgba(0, 0, 0, 0.24));
}
...
.dsh-shutdown-card-error { margin: -4px 0 14px; font-size: 12px; line-height: 18px; color: var(--dsw-alias-state-error-primary, #d03050); }
...
.dsh-shutdown-check-row input { width: 14px; height: 14px; margin: 0; cursor: pointer; accent-color: var(--dsw-alias-state-business-primary, #4c6ef5); }
...
.dsh-shutdown-btn-primary {
  background: var(--dsw-alias-button-primary-fill, #1f2329);
  color: var(--dsw-alias-label-primary-foreground, #fff);
  border-color: transparent;
}
.dsh-shutdown-btn-primary:hover { opacity: 0.9; background: var(--dsw-alias-button-primary-hover, #1f2329); }
.dsh-shutdown-screen {
...
.dsh-shutdown-check {
  ...
  background: var(--dsw-alias-state-success-primary, #22a06b); color: var(--dsw-alias-label-primary-foreground, #fff);
  display: flex; align-items: center; justify-content: center;
}
...
.dsh-shutdown-settings-check input {
  ...
  accent-color: var(--dsw-alias-state-business-primary, #4c6ef5);
}
`;
		const cls = {
		...
		*/
		function useShutdownFlow() {
			...
			return {
				...
				cancel: (0, react.useCallback)(() => setPhase("idle"), []),
				confirm: (0, react.useCallback)((dontAskAgain) => {
		...
		function HeaderActionInner(props) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
				...
				(flow.phase === "confirm" || flow.phase === "error") && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ConfirmDialog, {
					t: tr,
					error: flow.phase === "error",
					onCancel: flow.cancel,
					onConfirm: flow.confirm
				}),
				flow.screen && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ShutdownScreen, { t: tr })
			] });
		}
		...
		//#endregion
		//#region src/client/HeroAction.tsx
		/**
		...
		*/
		function selectHeroPhase(state) {
			const current = state.current;
			if (current === void 0) return true;
			return state.byId?.[current]?.blank === true;
		}
		function HeroActionInner(props) {
			const tr = composeT(props.t, detectLocale());
			const flow = useShutdownFlow();
			const { useSessions } = props;
			if (!(useSessions ? useSessions(selectHeroPhase) : false)) return null;
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					className: cls.heroAnchor,
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						type: "button",
		...
		*/
		function ShutdownHeroAction(props) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ErrorBoundary, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(HeroActionInner, { ...props }) });
		}
		//#endregion
